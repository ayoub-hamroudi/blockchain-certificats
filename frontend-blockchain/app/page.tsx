...
export default function LandingPage() {
  ...
  const steps = [
    ...
    },
    {
      icon: Search,
      title: "Verify",
      description: "Anyone with access can verify certificate authenticity",
  ...
  const features = [
    {
      ...
      description:
        "All certificates are permanently stored on the blockchain, ensuring tamper-proof academic records.",
    },
    {
      title: "Transparent Verification",
      description:
        "Authorized users can verify the authenticity of any certificate using blockchain technology.",
    },
    {
      title: "Multi-Party Workflow",
      description:
        "Secure generation, signing, and validation process involving multiple authorized parties.",
    },
  ]
      ...
      <section className="border-t bg-muted/30 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-lg text-muted-foreground">
            Connect your wallet to access the platform based on your role.
          </p>
          <Button size="lg" onClick={() => setShowWalletModal(true)} className="gap-2">
            Connect Wallet
            <ArrowRight className="h-4 w-4" />
