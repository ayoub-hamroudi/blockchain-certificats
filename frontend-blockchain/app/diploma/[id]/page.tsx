...
export default function DiplomaPage({ params }: DiplomaPageProps) {
  const { id } = use(params)
        ...
        <main className="container mx-auto flex min-h-[60vh] items-center justify-center px-4 py-12">
          <Card className="max-w-md p-8 text-center">
            ...
            <p className="mb-6 text-muted-foreground">
              This certificate is still being processed. The official diploma will be available once it has been fully validated.
            </p>
            <Button asChild>
              <Link href="/verify">Check Status</Link>
            </Button>
          </Card>
        </main>
      </div>
  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <main className="container mx-auto px-4 py-8 print:p-0">
        <Button variant="ghost" size="sm" className="mb-6 gap-2 print:hidden" asChild>
          <Link href="/verify">
                ...
                <div className="mt-auto grid grid-cols-2 gap-12 px-8">
                  ...
                  <div className="text-center">
                    <div className="mx-auto mb-2 h-12 w-32">
                      {/* Signature placeholder - elegant script simulation */}
                  ...
                  <div className="text-center">
                    <div className="mx-auto mb-2 h-12 w-32">
                      {/* Signature placeholder - different style */}
                      <svg viewBox="0 0 128 48" className="h-full w-full text-foreground/70">
                        <path
        ...
        {/* Verification URL */}
        <div className="mx-auto mt-6 max-w-[210mm] text-center print:hidden">
          <p className="text-sm text-muted-foreground">
